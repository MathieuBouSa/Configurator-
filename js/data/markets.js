...
globalThis.SALUS_MARKETS = {
  ...
  generators: {
    ...
    heat_pump_aw: {
      ...
      pilotVia: "RX30RF", icon: "mdi:heat-pump"
    },
    heat_pump_aa: {
    ...
    unknown: {
      ...
      pilotVia: null, icon: "mdi:help-circle-outline"
    }
  },
