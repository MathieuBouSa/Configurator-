...
| P19 | Savings hard to estimate | row 20 | Calculator: 4 inputs the customer knows, result as a **range** (% and EUR/year), "see the method" (degree-day model), calculation stored with the configuration | Working (fictional coefficients) |
